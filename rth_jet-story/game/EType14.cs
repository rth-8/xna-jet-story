...
namespace rth_jet_story.game
{
    class EType14 : Enemy
    {
        ...
        {
            eb_left[0] = content.Load<Texture2D>("images/enemies/enemy_14_0_0");
            eb_left[1] = content.Load<Texture2D>("images/enemies/enemy_14_0_1");

            eb_right[0] = content.Load<Texture2D>("images/enemies/enemy_14_1_0");
            eb_right[1] = content.Load<Texture2D>("images/enemies/enemy_14_1_1");
        }
        ...
        public EType14(float m, float x, float y, float z, int w, int h)
            : base(m, x, y, z, w, h)
        {
            this.initEnemy();
        }
