...
{
    class EType13_Shot : Shot
    {
        private static Texture2D e13_shot;

        public static void loadImages(ContentManager content)
        {
            e13_shot = content.Load<Texture2D>("images/shots/e3_e13_shot");
        }
        ...
        public EType13_Shot(float m, float x, float y, float z, int w, int h)
            : base(m, x, y, z, w, h)
        {
        }
        ...
        {
            g.Draw(e13_shot, this.position, this.col);    
        }
